...
CalendarDateSelect.prototype = {
  ...
  initButtonsDiv: function()
  {
    ...
    if (this.options.get("time"))
    {
      ...
      // Timezone modification starts here
    var local_tzone_div = document.getElementById("local_time");
    if (local_tzone_div == null){
        var pr_time = new Date();
    }
    else{
        var pr_time = new Date(local_tzone_div.value);
    }
    var t = pr_time;
    // Timezone modification ends here
     // var t = new Date();
  ...
  updateSelectedDate:function(partsOrElement, via_click) {
    ...
    // Timezone modification ends here
      if ((pr_time - this.last_click_at) < 333) this.close();
      this.last_click_at = pr_time;
    }
  },
  ...
  today: function(now) {
    ...
    var d = pr_time; this.date = pr_time;
    // Timezone modification ends here
